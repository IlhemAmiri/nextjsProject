  ...
  return (
    <div>
      <div className="h-[400px] bg-cover bg-center bg-[url('/images/11.jpg')]">
        <div className="bg-[rgba(41,41,41,0.38)] backdrop-blur-md bg-opacity-30 text-white flex justify-between items-center px-6 lg:px-12 py-4 shadow-md">
          ...
          <div className="hidden md:flex flex-1 justify-center">
            <nav className="flex space-x-4 lg:space-x-20">
              <Link href="/" className="hover:text-[#1ECB15] font-outfit font-semibold text-sm lg:text-base">Home</Link>
              <Link href="/cars" className="hover:text-[#1ECB15] font-outfit font-semibold text-sm lg:text-base">Cars</Link>
              <Link href="#" className="hover:text-[#1ECB15] font-outfit font-semibold text-sm lg:text-base">Booking</Link>
              <Link href="/profile" className="hover:text-[#1ECB15] font-outfit font-semibold text-sm lg:text-base">My Account</Link>
              <Link href="#" className="hover:text-[#1ECB15] font-outfit font-semibold text-sm lg:text-base">Blog</Link>
              <Link href="#" className="hover:text-[#1ECB15] font-outfit font-semibold text-sm lg:text-base">FAQ</Link>
            </nav>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden bg-[rgba(41,41,41,0.8)] text-white flex flex-col items-center space-y-4 py-4">
            <Link href="/" className="hover:text-[#1ECB15] font-outfit font-semibold text-sm">Home</Link>
            <Link href="/cars" className="hover:text-[#1ECB15] font-outfit font-semibold text-sm">Cars</Link>
            <Link href="#" className="hover:text-[#1ECB15] font-outfit font-semibold text-sm">Booking</Link>
            <Link href="/profile" className="hover:text-[#1ECB15] font-outfit font-semibold text-sm">My Account</Link>
            <Link href="#" className="hover:text-[#1ECB15] font-outfit font-semibold text-sm">Blog</Link>
            <Link href="#" className="hover:text-[#1ECB15] font-outfit font-semibold text-sm">FAQ</Link>
            {isAuth ? (
              <button
                onClick={handleLogout}
              ...
              <Link href="/signin">
                <div className="bg-[#1ECB15] text-white items-center justify-center rounded w-28 h-9 font-extrabold text-sm tracking-wide font-outfit transition-transform hover:scale-105">
                  Sign In
                </div>
              </Link>
            )}
